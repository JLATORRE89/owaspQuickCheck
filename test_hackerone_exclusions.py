...
import unittest
from hackerone_exclusions import should_exclude_test, HACKERONE_CORE_INELIGIBLE
...
class TestHackerOneExclusions(unittest.TestCase):
    def test_exclusion_disabled(self):
        ...
        self.assertFalse(should_exclude_test(excluded_check, exclude_hackerone=False))
        
    def test_security_headers_exclusion(self):
        """Test that security header checks are excluded"""
        excluded_check = "Test for Missing Security Headers"
        self.assertTrue(should_exclude_test(excluded_check, exclude_hackerone=True))
    ...
    def test_non_excluded_check(self):
        ...
        self.assertFalse(should_exclude_test(non_excluded_check, exclude_hackerone=True))
